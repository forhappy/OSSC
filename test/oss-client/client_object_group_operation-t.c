...
int main()
{
	...
	//client_get_object_group_to_file(client, request, local_file, NULL);
	client_get_object_group_to_buffer_2nd(client, request, &buffer, &file_len, NULL);
	...
	//}
	//client_get_object_group_metadata(client, source_bucket_name, source_key, NULL);
