 ...
 * =============================================================================
 *
 *       Filename:  client_create_bucket-t.c
 *
 *    Description:  client_create_bucket testcase.
 *
...
size_t client_create_bucket_callback(void *ptr, size_t size, size_t nmemb, void *stream)
{
	size_t r = size * nmemb;
		...
		unsigned short *retcode)
{
	...
	if (curl != NULL) {
		...
		curl_easy_setopt(curl, CURLOPT_WRITEFUNCTION, client_create_bucket_callback);
