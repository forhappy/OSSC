...
struct oss_response_header_overrides_s {
	...
	void (*set_cache_control)(oss_response_header_overrides_t *overrides, const char *cache_control);

	const char * (*get_content_disposition)(oss_response_header_overrides_t *overrides);
	void (*set_content_disposition)(oss_response_header_overrides_t *overrides, const char *content_disposition);

	const char * (*get_content_encoding)(oss_response_header_overrides_t *overrides);
	void (*set_content_encoding)(oss_response_header_overrides_t *overrides, const char *content_encoding);

	const char * (*get_content_language)(oss_response_header_overrides_t *overrides);
	void (*set_content_language)(oss_response_header_overrides_t *overrides, const char *content_language);

	const char * (*get_content_type)(oss_response_header_overrides_t *overrides);
	void (*set_content_type)(oss_response_header_overrides_t *overrides, const char *content_type);

	const char * (*get_expires)(oss_response_header_overrides_t *overrides);
	void (*set_expires)(oss_response_header_overrides_t *overrides, const char *expires);
};
