...
/**
 * @defgroup oss_get_object_group_request_t oss_get_object_group_request_t
 * @{
 */

/**
 * struct oss_get_object_group_request_s 内部使用 \n
 * oss_get_object_group_request_t 开发者使用
 */
typedef struct oss_get_object_group_request_s oss_get_object_group_request_t;

/**
 * 指定从OSS下载Object group的请求参数
 */
struct oss_get_object_group_request_s {
	 ...
	 * @retval const char *
	 */
	const char * (*get_bucket_name)(oss_get_object_group_request_t *request);
	 ...
	 * @retval void
	 */
	void (*set_bucket_name)(oss_get_object_group_request_t *request, const char *bucket_name);
	 ...
	 * @retval const char *
	 */
	const char * (*get_key)(oss_get_object_group_request_t *request);
	 ...
	 * @retval void
	 */
	void (*set_key)(oss_get_object_group_request_t *request, const char *key);
	 ...
	 * @retval const char *
	 */
	const char * (*get_modified_since_constraint)(oss_get_object_group_request_t *request);
	 ...
	 * @retval void
	 */
	void (*set_modified_since_constraint)(oss_get_object_group_request_t *request, const char *modified_since_constraint);
	 ...
	 * @retval void
	 */
	void (*get_range)(oss_get_object_group_request_t *request, long *start, long *length);
	 ...
	 * @retval void
	 */
	void (*set_range)(oss_get_object_group_request_t *request, long start, long length);
	 ...
	 * @retval NULL 表示失败
	 */
	oss_response_header_overrides_t * (*get_response_headers)(oss_get_object_group_request_t *request);
	 ...
	 * @retval void
	 */
	void (*set_response_headers)(oss_get_object_group_request_t *request, oss_response_header_overrides_t *response_headers);
...
/**
 * oss_get_object_group_request_t构造函数
 * @param bucket_name [in] Bucket名称
 * @param key [in] Object名称
 * @return 返回oss_get_object_group_request_t结构指针
 * @retval 非空 表示成功
 * @retval NULL 表示失败
 * @note 用户不需要句柄后要调用相应的finalize函数释放空间
 */
extern oss_get_object_group_request_t *
get_object_group_request_initialize(const char *bucket_name, const char *key);

/**
 * oss_get_object_group_request_t析构函数
 * @param request [in] 标识一个oss_get_object_group_request_t结构指针
 * @retval void
 * @pre request 必须使用get_object_group_request_initialize的返回值
 */
extern void 
